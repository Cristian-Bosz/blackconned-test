...
const ProductDetails = ({ products }) => {
  ...
  return (
    <>
    <NavBar/>
      <section className="container-fluid productDetails-bg mt-5">
                          ...
                          <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <a href="#" class="btn btn-success btn-lg" name="submit" value="buy">Buy</a>
                                    </div>
                                    <div class="col d-grid">
                                        <a href="#" class="btn btn-outline-success btn-lg" name="submit" value="addtocard">Add To Cart</a>
                                    </div>
                                </div>
                            </form>
