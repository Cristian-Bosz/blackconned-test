            ...
            <div className='container-categories'>
                <div class="row row-categories">
                    <div class="col-12 col-md-4 p-5 mt-3">
                        <Link to="/">
                        <img src={auriculares} alt="imagen de auriculares sony" class="rounded-circle img-fluid border shadow-sm img-categorias"/></Link>
                        <h3 class="text-center mt-3 mb-3">Headphones</h3>
                        <p class="text-center"><button class="btn btn-success">Go shop</button></p>
                    </div>
                    <div class="col-12 col-md-4 p-5 mt-3">
                        <Link to="/">
